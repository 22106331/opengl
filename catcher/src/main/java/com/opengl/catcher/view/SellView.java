...
public class SellView{
	...
	public static List<BN2DObject> background=new ArrayList<BN2DObject>();//���BNObject����
	public static List<BN2DObject> xinglist=new ArrayList<BN2DObject>();//���BNObject����
	public static List<Integer> jiazhilist=new ArrayList<Integer>();//���BNObject����
	public static List<Integer> xingcountlist=new ArrayList<Integer>();//���BNObject����
